function [ value ] = rate_constant_no_drier( T, type, Hrxn )
...
rate_parameters(21).A = 0; %0.0635; modification on 12_09
rate_parameters(21).Ea = 0;
rate_parameters(21).alpha = 0;

% Peroxy crosslink decomposition type 23
% rate_parameters(22).A = 0.1873;
% rate_parameters(22).Ea = 0;
% rate_parameters(22).alpha = 0;

rate_parameters(22).A = 1e15; %5e8;
rate_parameters(22).Ea = 40;
rate_parameters(22).alpha = 1;

% Addition type 24
rate_parameters(23).A = 1e8;
...
rate_parameters(26).A = 0; %1.7e14*1.7e14; % (1st step * 2nd step) modification on 12_09
