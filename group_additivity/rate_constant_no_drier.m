...
rate_parameters(11).A =  0.5*1e7; % 6.6; %
...
rate_parameters(13).A = 0; %2.7e8; % for acac, 1.7e14 for oct
rate_parameters(13).Ea = 0; %13; % for acac, 19.7 for oct
...
rate_parameters(26).A = 0; %1.7e14*1.7e14; % (1st step * 2nd step)
rate_parameters(26).Ea = 0; %22.22+5.9; % (1st step + 2nd step)
